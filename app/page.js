    ...
    <>
      <div className={styles.banner}>
        <div className={styles.slider} style={{"--quantity": 8}}>
          ...
          <div className={styles.item} style={{"--position": 6}}><img src={`${baseRoute}/images/css_200x200.svg`}/></div>
          <div className={styles.item} style={{"--position": 7}}><img src={`${baseRoute}/images/ux-ui_200x200.svg`}/></div>
          <div className={styles.item} style={{"--position": 8}}><Link href="/new"><Image src={`${baseRoute}/images/azure-devops_200x200.svg`} width={200} height={200} alt="Azure DevOps"/></Link></div>
        </div>
